...
export default function AuthLogin({ isDemo = false }) {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    ...
    try {
      ...
      // backend errors usually under error.detail or error.non_field_errors
      const errMsg = error.detail || (error.non_field_errors && error.non_field_errors[0]) || 'Login failed';
